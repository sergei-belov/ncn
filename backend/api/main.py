...
class Application(FastAPI):
    ...
    @staticmethod
    async def pms_error_handler(_request: Request, exc: PmsError) -> JSONResponse:
        """Convert a domain ``PmsError`` into the public error envelope.

        Args:
            _request: Request that raised the error.
    ...
    async def validation_error_handler(_request: Request, exc: RequestValidationError) -> JSONResponse:
        ...
        Args:
            _request: Request that failed validation.
    ...
    async def http_error_handler(_request: Request, exc: HTTPException) -> JSONResponse:
        ...
        Args:
            _request: Request that raised the exception.
    ...
    async def internal_error_handler(_request: Request, _exc: Exception) -> JSONResponse:
        """Return the generic response for an unexpected server exception.
